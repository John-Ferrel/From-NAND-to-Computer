...
3. **非门（NOT gate）**
   ...
   <img title="" src="file:///img_logical_gate/and-or-not.png" alt="and-or-not.png" width="378">
   
   <img title="" src="file:///img_logical_gate/nand-nor.png" alt="nand-nor.png" width="376">
   
   <img title="" src="file:///img_logical_gate/xor-xnor.png" alt="xor-xnor.png" width="376">
...
<img title="" src="file:///img_logical_gate/nand-mos.png" alt="nand-mos.png" width="180" data-align="center">

<img title="" src="file:///img_logical_gate/nor-mos.png" alt="nor-mos.png" width="170" data-align="center">
...
![trans.png](img_logical_gate\trans.png)

#### 其他逻辑门

| 逻辑门 | 示例                                 | 备注           |
| --- | ---------------------------------- | ------------ |
| NOT | ![](img_logical_gate\nand2not.png) | 输入信号同时接入NAND |
| AND | ![](img_logical_gate\nand2and.png) | 输出信号取反       |
| OR  | ![](img_logical_gate\nand2or.png)  | 输入信号取反       |
| NOR | ![](img_logical_gate\nand2nor.png) | 对输入和输出信号同时取反 |
